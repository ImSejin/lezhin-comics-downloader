...
public class LoginFailureException extends RuntimeException {
     ...
     *
     * <p> The following script is in login page.
     * First, {@code __LZ_ERROR_CODE__} is {@code ''}.
     * If you failed to login, it is assigned to error code
     * and {@code __LZ_ERROR__} is assigned to error message.
     *
     * <pre>{@code
     *     <script>
